...
string Patient::getTown() { return town; }
...
int Patient::getLastIllness() { return patientIllness.back().getRepresentation(); }
...
void Patient::setName(string fn, string ln) { name = fn + ln; }

void Patient::setTown(string town_in) { town = town_in; }

void Patient::setIllness(Illness ill) { patientIllness.push_back(ill); }

void Patient::setTreatment(Treatment treats) { patientTreatments.push_back(treats); }
